          ...
          "; ?>
           ...
           <?php 
            ...
            if(isset($_POST['submit'])){
              ...
              echo "<script>alert('Your Cover Photo Is Updated!')</script>";
              echo "<script>window.open('profile.php?u_id=$user_id','_self')</script>";
              }
            }
		...
		<?php
			...
			<div id='own_posts'>
				<div class='row'>
					...
					<div class='col-sm-6'>
						...
						<h4><small style='color:black;'>Created a new project on <strong>$post_date</strong></small></h4>
					</div>
					<div class='col-sm-4'>
			...
			<div id='own_posts'>
				<div class='row'>
					...
					<div class='col-sm-6'>
						<h3><a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
						<h4><small style='color:black;'>Completed a new project on <strong>$post_date</strong></small></h4>
					</div>
					<div class='col-sm-4'>
