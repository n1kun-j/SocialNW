							  ...
							  <div class="modal-dialog">
							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
									...
									<pre >Answer the above question we will ask you this question if you forget your <br>password.
									</pre>
									<br><br>
									</form>
									<?php
									if(isset($_POST['sub'])){
										...
										$update = "update users set recovery='$bfn' where user_id='$user_id'";
...
<?php 
	if(isset($_POST['update'])){
		...
		$update = "update users set f_name='$f_name', l_name='$l_name',user_name='$u_name',describe_user='$describe_user',role='$role', user_pass='$u_pass',user_email='$u_email',user_country='$u_country',user_gender='$u_gender',user_birthday='$u_birthday' where user_id='$user_id'";
