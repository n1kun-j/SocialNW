...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;"><strong>Campus Connect</strong></h1></center>
			</div>
		</div>
	</div>
	<div class="row">
...
include("includes/connection.php");
	...
	$recovery_account = htmlentities(mysqli_real_escape_string($con,$_POST['recovery']));

	$select_user = "select * from users where user_email='$email' AND recovery='$recovery_account'";
